...
const SignUP=()=>{
    ...
    return (
        ...
        <Form.Control type="number" placeholder="Enter Phone number" required ref={phoneNumberInputRef}/>
        </Form.Group>
          ...
          <Button style={{background:"#C85C8E",border:"1px solid #C85C8E"}} className='mb-2' type="submit" >
            Submit
          </Button>
          <p className='alignCenter'>Have an account? <NavLink to='/Login' className="mb-3 alignCenter decorationNone ">Login</NavLink></p>
